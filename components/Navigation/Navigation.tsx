...
import { smoothScrollTo, getActiveSection } from '@/utils/scroll';
...
export default function Navigation() {
  ...
  useEffect(() => {
    const onScroll = () =>
      setActive(getActiveSection(NAV_LINKS.map((l) => l.id)));
    ...
    <nav className={styles.nav} aria-label="Primary navigation">
      <div className={styles.inner}>
        ...
        <div className={styles.socials}>
          <a
            href="mailto:jeshaiahmamulleno@gmail.com"
          ...
          >
            <svg width="17" height="17" viewBox="0 0 24 24"
              ...
              <path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839
                ...
                1.026A9.564 9.564 0 0 1 12 6.844a9.59 9.59 0 0 1 2.504.337
                c1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1
                2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566
                4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747
                0 .268.18.58.688.482A10.02 10.02 0 0 0 22 12.017C22 6.484
                17.522 2 12 2z" />
            </svg>
          </a>

          <a
            href="https://linkedin.com/in/jeshaiah-mamulleno"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.socialBtn}
          ...
          >
            <svg width="17" height="17" viewBox="0 0 24 24"
              ...
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037
                ...
                4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0
